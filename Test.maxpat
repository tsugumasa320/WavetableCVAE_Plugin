...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 1124.0, 780.0, 44.0, 44.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 29.0, 71.0, 44.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1124.0, 608.0, 304.0, 116.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 457.0, 798.135253999999918, 304.0, 116.0 ],
					"varname" : "bp.LPF",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1124.0, 468.0, 201.0, 116.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 457.0, 676.135253999999918, 201.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 931.0, 195.0, 163.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1034.0, 48.0, 133.0, 116.0 ],
					"varname" : "bp.MIDI In",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1124.0, 323.0, 113.0, 116.0 ],
					"varname" : "bp.VCA",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1258.5, 323.0, 100.0, 116.0 ],
					"varname" : "bp.AD",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1124.0, 194.0, 314.0, 116.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 374.0, 132.0, 314.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 103.0, 508.0, 190.0, 116.0 ],
					"varname" : "bp.Reverb 1",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 488.0, 874.0, 435.0, 214.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 14.0, 704.0, 435.0, 214.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 103.0, 339.0, 337.0, 138.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 14.0, 121.0, 337.0, 138.0 ],
					"save" : [ "#N", "vst~", "loaduniqueid", 0, "/Users/tsugumasayutani/Library/Audio/Plug-Ins/VST3/WavetableSynth.vst3", ";" ],
...
,
					"snapshot" : 					{
						...
						"embed" : 1,
						"snapshot" : 						{
							"pluginname" : "WavetableSynth.vst3",
							"plugindisplayname" : "WavetableSynth",
							"pluginsavedname" : "~/Library/Audio/Plug-Ins/VST3/WavetableSynth.vst3",
...
,
									"fileref" : 									{
										"name" : "WavetableSynth",
										"filename" : "WavetableSynth.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "56845b2d7714a880bac1342eb0ea8fc0"
									}
...
,
					"text" : "vst~ /Users/tsugumasayutani/Library/Audio/Plug-Ins/VST3/WavetableSynth.vst3",
					"varname" : "vst~",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 396.0, 266.0, 130.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 249.0, 129.5, 101.0, 51.0 ],
					"presentation_linecount" : 3,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 196.0, 231.0, 122.0, 60.0 ],
					"presentation_linecount" : 4,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 196.0, 146.0, 50.0, 22.0 ],
					"text" : "midiin"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 196.0, 198.0, 143.0, 22.0 ],
					"text" : "midiparse"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 513.5, 165.0, 210.0, 47.0 ],
					"presentation_linecount" : 3,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 563.5, 225.0, 160.0, 30.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 514.5, 130.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 142.0, 70.0, 138.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 103.0, 71.0, 37.0, 23.0 ],
					"text" : "plug"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 396.0, 225.0, 108.0, 23.0 ],
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 396.0, 195.0, 32.5, 23.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 396.0, 165.0, 107.0, 23.0 ],
					"text" : "makenote 60 4n"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 396.0, 75.499999953124984, 336.0, 53.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 488.0, 647.0, 435.0, 214.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 14.0, 481.0, 435.0, 214.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 99.0, 647.0, 372.0, 214.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 14.0, 263.0, 372.0, 214.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 269.0, 106.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 163.0, 48.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 1 ],
					"midpoints" : [ 493.5, 191.0, 419.0, 191.0 ],
					"source" : [ "obj-11", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 405.5, 190.0, 405.5, 190.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 722.5, 139.5, 449.5, 139.5 ],
					"source" : [ "obj-13", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 405.5, 220.0, 405.5, 220.0 ],
					"source" : [ "obj-8", 0 ]
				}
		...
		"parameters" : 		{
			"obj-14" : [ "vst~", "vst~", 0 ],
			"obj-16::obj-12" : [ "freq_scale[1]", "LinLog", 0 ],
			"obj-16::obj-26" : [ "amp_scale[1]", "LinLog", 0 ],
			"obj-16::obj-30" : [ "freq_domain_low[1]", "freq_domain_low", 0 ],
			"obj-16::obj-31" : [ "domain_low_midi[1]", "domain_low_midi", 0 ],
			"obj-16::obj-36" : [ "domain_high_midi[1]", "domain_high_midi", 0 ],
			"obj-16::obj-37" : [ "freq_domain_high[1]", "freq_domain_high", 0 ],
			"obj-16::obj-42::obj-2" : [ "pastebang[1]", "pastebang", 0 ],
			"obj-16::obj-7" : [ "display_mode[1]", "display", 0 ],
			"obj-16::obj-9" : [ "PollingInterval[1]", "PollingInterval", 0 ],
			"obj-18::obj-1" : [ "Time", "Time", 0 ],
			"obj-18::obj-25" : [ "Cutoff", "Cutoff", 0 ],
			"obj-18::obj-26" : [ "Reflections", "Reflections", 0 ],
			...
			"obj-20::obj-32" : [ "Decay", "Decay", 0 ],
			"obj-20::obj-45" : [ "Attack", "Attack", 0 ],
			"obj-23::obj-33" : [ "Quadrants", "Quadrants", 0 ],
			"obj-23::obj-55" : [ "Bypass", "Bypass", 0 ],
			"obj-23::obj-80" : [ "BankCV", "CV", 0 ],
			"obj-27::obj-106" : [ "CV3[1]", "CV3", 0 ],
			"obj-27::obj-107" : [ "Linear[1]", "Linear", 0 ],
			"obj-27::obj-11" : [ "PWM[1]", "PWM", 0 ],
			"obj-27::obj-129" : [ "CV2[1]", "CV2", 0 ],
			"obj-27::obj-36" : [ "PW[1]", "PW", 0 ],
			"obj-27::obj-4" : [ "Waveform[1]", "Waveform", 0 ],
			"obj-27::obj-45" : [ "FreqMode[1]", "FreqMode", 0 ],
			"obj-27::obj-46" : [ "Offset[1]", "Offset", 0 ],
			"obj-27::obj-51" : [ "Freq[1]", "Freq", 0 ],
			"obj-27::obj-53" : [ "Mute[1]", "Mute", 0 ],
			...
			"obj-30::obj-1" : [ "refresh", "refresh", 0 ],
			"obj-30::obj-12::obj-2" : [ "pastebang[2]", "pastebang", 0 ],
			"obj-30::obj-9" : [ "MIDI_out_LED", "MIDI_out_LED", 0 ],
			"obj-31::obj-20" : [ "ModWheelActivityLED", "ModWheelActivityLED", 0 ],
			"obj-31::obj-28" : [ "Bend", "Bend", 0 ],
			"obj-31::obj-69" : [ "1voctled", "1voctled", 0 ],
			"obj-32::obj-29" : [ "3", "3", 0 ],
			"obj-32::obj-32" : [ "2", "2", 0 ],
			"obj-32::obj-33" : [ "4", "4", 0 ],
			"obj-32::obj-37" : [ "Mute", "Mute", 0 ],
			"obj-32::obj-39" : [ "1", "1", 0 ],
...
,
			"parameter_overrides" : 			{
				"obj-16::obj-12" : 				{
					"parameter_longname" : "freq_scale[1]"
				}
,
				"obj-16::obj-26" : 				{
					"parameter_longname" : "amp_scale[1]"
				}
,
				"obj-16::obj-30" : 				{
					"parameter_longname" : "freq_domain_low[1]"
				}
,
				"obj-16::obj-31" : 				{
					"parameter_longname" : "domain_low_midi[1]"
				}
,
				"obj-16::obj-36" : 				{
					"parameter_longname" : "domain_high_midi[1]"
				}
,
				"obj-16::obj-37" : 				{
					"parameter_longname" : "freq_domain_high[1]"
				}
,
				"obj-16::obj-42::obj-2" : 				{
...
,
				"obj-16::obj-7" : 				{
					"parameter_longname" : "display_mode[1]"
				}
,
				"obj-16::obj-9" : 				{
					"parameter_longname" : "PollingInterval[1]"
				}
,
				"obj-23::obj-80" : 				{
